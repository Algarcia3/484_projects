...
@endif
    ...
    {{ Form::open(array('url' => 'restaurants/' . $restaurants->restaurant_id . '/addmenuitem', 'class' => 'form-signin')) }}
            @if (count($errors) > 0)
            ...
            {{ Form::text('item_name', null, array('placeholder'=>'Item Name', 'class'=>'form-control', 'style' => 'width: 500px' ) ) }}
            {{ Form::text('menu_price', null, array('placeholder'=>'Menu Price', 'class'=>'form-control', 'style' => 'width: 500px' ) ) }}
            {{ Form::textarea('menu_description', null, array('placeholder'=>'Menu Item Description', 'class'=>'form-control', 'style' => 'width: 500px' ) ) }}
            &nbsp;
            {{ Form::submit('Add Menu Item', array('class' => 'btn btn-lg btn-primary btn-block btn-signin', 'style' => 'width: 200px')) }}
    {{ Form::close() }}
</div>
</body>
