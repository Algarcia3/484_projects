...
@endif
    ...
    {{ Form::open(array('url' => 'addrestaurant', 'class' => 'form-signin')) }}
            @if (count($errors) > 0)
            ...
            {{ Form::text('restaurant_name', null, array('placeholder'=>'Restaurant Name', 'class'=>'form-control', 'style' => 'width: 500px' ) ) }}
            {{ Form::text('street_address', null, array('placeholder'=>'Street Address', 'class'=>'form-control', 'style' => 'width: 500px' ) ) }}
            {{ Form::text('city', null, array('placeholder'=>'City', 'class'=>'form-control', 'style' => 'width: 500px' ) ) }}
            {{ Form::text('state', null, array('placeholder'=>'State', 'class'=>'form-control', 'style' => 'width: 500px' ) ) }}
            {{ Form::text('website', null, array('placeholder'=>'Website', 'class'=>'form-control', 'style' => 'width: 500px' ) ) }}
            {{ Form::submit('Add Restaurant', array('class' => 'btn btn-lg btn-primary btn-block btn-signin', 'style' => 'width: 200px')) }}
    {{ Form::close() }}
</div>
</body>
